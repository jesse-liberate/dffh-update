...
$string['bookingcompleted_approvalnotreqd'] = 'Your booking has been completed.';
$string['bookingplaced_approvalrequired'] = 'Your booking for this session has been placed but requires manager approval';
$string['bookingfull'] = 'Booking full';
$string['bookingopen'] = 'Register';
...
$string['cronemailinterestedfaceoface'] = 'Face-to-Face email interested face-to-face to admin';
...
$string['details'] = 'About this event';
...
$string['booking_change_notification'] = 'Booking change notification';
$string['booking_change_notification_help'] = 'When this option is enabled, participants will receive an email notification when the booking details are changed.';
...
$string['error:sessiondate'] = 'Please choose proper session date.';
...
$string['placeholder:support_contact_name'] = '[support_contact_name]';
$string['placeholder:support_contact_email'] = '[support_contact_email]';
$string['placeholder:manager_firstname'] = '[manager_firstname]';
...
$string['sessionrequiresmanagerapproval'] = "This session requires manager approval to book, please see your manager if you have any questions.";
...
$string['setting:defaultcancellationmessagedefault'] = '
Dear [firstname],<br/><br/>

This message is to advise you that your booking for the following course has been cancelled:<br/><br/>

Course:   [facetofacename]<br/><br/>

Duration:[duration]<br/>
Date(s):[alldates]<br/><br/>

Location:   [session:location]<br/>
Venue:   [session:venue]<br/><br/>

***BOOKING CANCELLED***<br/><br/>

If you have further queries, please contact [support_contact_name].<br/>
Kind regards,<br/>
[support_contact_name]<br/>
[support_contact_email]<br/>
<p style="text-align:center">Your success is our goal!
';
...
You have successfully been enrolled in the following course:<br/><br/>

Course: [facetofacename]<br/>
Duration: [duration]<br/>
Date(s): [alldates]<br/><br/>
...
***Please ensure you arrive and are ready to participate before your session commences***<br/><br/>

If you are unable to attend for any reason, as a courtesy to the [support_contact_name] Team, we would appreciate your written advice via the email below at least 24 hours prior to the course\'s date. Please email [support_contact_name] at [support_contact_email].<br/> 
You will receive a reminder before this course.<br/>
If you have further queries, please contact [support_contact_name].<br/>
Kind regards,<br/>
[support_contact_name]<br/>
[support_contact_email]<br/>
...
$string['setting:defaultreminderinstrmngrdefault'] = '*** Reminder only ****<br/><br/>

Your staff member [firstname] [lastname] is booked to attend and above course and has also received this reminder email.<br/><br/>

If you are not their Team Leader / Manager and believe you have received this email by mistake please reply to this email.<br/><br/>

*** [firstname] [lastname]\'s reminder email is copied below ****<br/>
';
...
$string['setting:defaultremindermessagedefault'] = '
Dear [firstname],<br/><br/>

This is a reminder that you have been booked into the following course:<br/><br/>
...
***Please arrive ten minutes before the course starts***<br/><br/>
...
[support_contact_name]<br/>
[support_contact_email]<br/>
<p style="text-align:center">Your success is our goal!<br/>
';
...
$string['setting:defaultrequestinstrmngrdefault'] = '
Dear [manager_firstname],<br/><br/>

This message is to advise that [firstname] [lastname] has requested to be booked into the following course. As their Team Leader / Manager, this request must be approved by you before they are able to attend.<br/><br/>
...
[attendeeslink]<br/>
If you have further queries regarding the course, please contact [support_contact_name].<br/>
Kind regards,<br/>
[support_contact_name]<br/>
[support_contact_email]<br/>
<p style="text-align:center">Your success is our goal!<br/>
';
$string['setting:defaultrequestmessagedefault'] = '
Dear [firstname],<br/><br/>

Thank you for expressing interest in a [support_contact_name] course. Your request to attend the following session has been sent to your manager:<br/><br/>
...
If you have further queries regarding the approval process, please contact your manager. If you have queries relating to the course, please contact [support_contact_name].<br/>
Kind regards,<br/>
[support_contact_name]<br/>
[support_contact_email]<br/>
<p style="text-align:center">Your success is our goal!
...
$string['setting:defaultwaitlistedmessagedefault'] = '
Dear [firstname],<br/><br/>

Thank you for expressing interest in a [support_contact_name] course.  This message is to advise you that you have been added to the waitlist for the following course:<br/><br/>

Course: [facetofacename]<br/><br/>

***Please note this is not a course booking confirmation***<br/><br/>

As you have registered your interest in this course, you will be contacted directly by [support_contact_name] when sessions become available.<br/><br/>

If you change your mind or your circumstances change, to remove yourself from this waitlist please return to this course and click Cancel Booking. Please note there is no waitlist removal confirmation email.<br/><br/>
...
$string['setting:fromaddressdefault'] = 'support@mindatlas.com';
...
$string['status_booked_cancel'] = 'Cancel Booking';
$string['status_waitlisted_cancel'] = 'Cancel Waitlist';
...
If text is populated in the about this event field, the details text will be displayed on the user signup page in the "About this event" field.
...
$string['facetoface_data_help'] = 'A list of all the forms created using Form Builder. ';
...
$string['awaitingapproval'] = 'Your booking for this session has been placed but requires manager approval';

// MA-MODIFIED ===>
$string['notification:cancelrequestmessage'] = 'The request to attend <strong>{$a->activityname}</strong> (<strong>{$a->coursename}</strong> training), {$a->datetime} has been cancelled';
$string['notification:requestmessage'] = 'A request to attend <strong>{$a->activityname}</strong> (<strong>{$a->coursename}</strong> training)';
$string['notification:approvedmessage'] = 'The booking <strong>{$a->activityname}</strong> (<strong>{$a->coursename}</strong> training) has been approved';
$string['notification:confirm'] = 'The request for booking <strong>{$a->activityname}</strong> (<strong>{$a->coursename}</strong> training) has been sent to your manager';
$string['notification:confirmmanager'] = 'Course booking request awaiting your approval. Click on <a href="{$a->url}">the link</a> to approve, decline or decide later the <strong>{$a->activityname}</strong> (<strong>{$a->coursename}</strong> training)';
$string['notification:confirmmanagercontent'] = 'Hi {$a->fullname},
A request has been sent for your approval:

{$a->content}
';
$string['session:approvalmanagersubject'] ='FOR APPROVAL: request to attend training for {$a->staffname}';
$string['session:approvalmanagercontent'] = 'Dear {$a->managerfirstname}, <br/><br/>

This message is to advise that {$a->staffname} has requested to be <br/>
booked into the following course. <br/><br/>

As their Team Leader / Manager, this request must be approved by you before<br/>
they are able to attend. <br/><br/>

Course: {$a->activityname} <br/>
Duration: {$a->duration} <br/>
Date(s): {$a->date}  <br/>
Location: {$a->location}<br/>
Venue: {$a->venue}<br/><br/>

Please follow the link below to approve the request: Click on <a href="{$a->url}">the link</a> <br/><br/>

If you have further queries regarding the course, please contact<br/>
{$a->supportcontactname}. <br/><br/>

Kind regards, <br/>
{$a->supportcontactname}<br/>
{$a->supportcontactemail}';
$string['course_module_name'] = '<strong>{$a->modulename}</strong>';
$string['cancel_session_link']='. To cancel your booking, click on <a href="{$a}"> this link</a>.';
$string['placeholder:cancelsessionlink'] = '[cancelsessionlink]';

$string['sessioncancel_subject']='Course booking cancellation: the request to attend <strong>{$a->facetofacename}</strong> (<strong>{$a->coursename} training</strong>) has been cancelled';
$string['sessioncancel_waitlist'] = 'Hi {$a->firstname},<br/><br/>

This is to advise that your booking on the following course has been cancelled:<br/><br/>

***BOOKING CANCELLED***<br/><br/>

Participant:   {$a->firstname} {$a->lastname}<br/>
Course:   <strong>{$a->facetofacename}</strong>({$a->coursename} training)<br/><br/>
...
Kind regards,<br/>
{$a->support_contact_name}<br/>
{$a->support_contact_email}';

$string['comments'] = 'Comments';
$string['view_all_sessions'] = 'View all my sessions';

$string['streamlinedaccess'] = 'Streamlined access';
$string['streamlinedaccess_help'] = 'When streamlined access is selected, this will sign up users whenever they click on the sign-up link without manager approval. This setting will disregard "Approval required" if checked';
$string['checkall/clearall'] = 'Check all / clear all';
$string['request_approval'] = 'Request Manager approval for this session';

$string['joinwaitlist'] = 'Join wait-list';
$string['managewaitlist'] = 'Manage wait-list';
// <=== MA-MODIFIED 


$string['error:selectfacetoface']="<div class='alert alert-error'>No face to face has been selected</div>";
$string['expressionsofinterest'] = 'Expressions of interest report';
$string['sessiondatesreport'] = 'Session dates report';
$string['enrolmentregistration'] = 'Course enrolment-registration';
$string['formatsessiondate'] = 'j F Y';
$string['formatsessiontime'] = 'h:i A';

$string['facetoface_data_help_help'] = '';
$string['booking_changemessage'] = 'Booking change message';
$string['booking_changemessage_help'] = 'This message is sent out whenever a booking is changed';
$string['setting:defaultbooking_changesubject'] = 'Default subject line for booking change emails.';
$string['setting:defaultbooking_changesubject_caption'] = 'Booking change subject';
$string['setting:defaultbooking_changesubjectdefault'] = 'Course booking change';
$string['setting:defaultbooking_changemessagedefault'] = 'Hi [firstname], <br/><br/>

This is to notify that your booking has been changed with following information:<br/><br/>
...
Date(s): [alldates] <br/>
Location: [session:location] <br/>
Venue/Room: [session:venue] <br/>
Facilitator: [session:room] <br/>
Detail: [session:detail] <br/>
***Please ensure you arrive and are ready to participate before your session commences*** <br/><br/>

If you are unable to attend for any reason, as a courtesy to the Learning and Development Team, <br/>
we would appreciate you letting us know at least 24 hours prior to the course\'s date.  <br/><br/>

To re-schedule your booking you need to cancel this booking and then re-book a new session. <br/><br/>

To cancel your booking, return to the site, then to the page for this course, and then select \'cancel\' from the booking information screen. <br/>
[details] <br/><br/>

You will receive a reminder [reminderperiod] business days before this course. <br/><br/>
...
';
$string['session_datechanges_users'] = 'Users will be notified for any new changes.';
$string['coachingdata'] = "Coaching data";
$string['bookingdetails'] = "Booking details";
$string['additional_details'] = 'Session description';
$string['additional_details_help'] = '**Session description** will be used to provide short description for the session';
