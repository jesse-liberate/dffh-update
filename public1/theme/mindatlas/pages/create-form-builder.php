...
$url = new moodle_url('/theme/mindatlas/pages/create-form-builder.php');
$PAGE->set_url($url);
...
$PAGE->navbar->add('Form builder management');
$PAGE->navbar->add('Create form', $url);
...
?>
<div id="mount-react-coach-create-form"></div>
<?php
echo $OUTPUT->footer();
