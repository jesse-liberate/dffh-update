...
$THEME->scss = function ($theme) {
    return theme_mindatlas_get_main_scss_content($theme);
};
...
$THEME->layouts = [
    ...
    // plain layout, just header, footer and page content without any wrapping
    'plain' => array(
        'file' => 'plain.php',
    ...
    // My trainingsessions page.
    'mytrainingsessionspage' => array(
        'file' => 'mytrainingsessionspage.php',
        'regions' => array('side-pre'),
        'defaultregion' => 'side-pre',
        'options' => array('nonavbar' => true, 'langmenu' => true, 'nocontextheader' => true),
    ),
    // My coachingsessions page.
    'mycoachingsessionspage' => array(
        'file' => 'mycoachingsessionspage.php',
        'regions' => array('side-pre'),
        'defaultregion' => 'side-pre',
        'options' => array('nonavbar' => true, 'langmenu' => true, 'nocontextheader' => true),
    ),
    ...
    'mytrainingsession' => array(
        'file' => 'my-training-session.php',
        'regions' => array('side-pre'),
        'defaultregion' => 'side-pre',
    ),
];
...
$THEME->prescsscallback = 'theme_mindatlas_get_pre_scss';
