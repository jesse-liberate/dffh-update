...
$file = '/blocks/training_report/dist/coachingReports.bundle.js';
$PAGE->requires->js($file.'?'.filemtime($CFG->dirroot.$file));

$url = new moodle_url('/blocks/training_report/pages/reports/coaching.php');
$PAGE->set_url($url);
...
<div class="">
    <div id="mount-react-coaching-report"></div>
</div>
