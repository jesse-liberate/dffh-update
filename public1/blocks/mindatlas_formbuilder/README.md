...
your module. You will probably want to modify block_mindatlas_formbuilder.php
...
[![Build Status](https://travis-ci.org/danielneis/moodle-block_mindatlas_formbuilder.svg?branch=master)](https://travis-ci.org/danielneis/moodle-block_mindatlas_formbuilder)


## Rename this block

1. Rename the "mindatlas_formbuilder" folder to "newname" (use lowercases).
2. Rename the block_mindatlas_formbuilder.php to block_newname.php
3. Rename  lang/en/block_mindatlas_formbuilder.php  to  lang/en/block_newname.php. Check $string['pluginname'] is correct
4. Replace all strings with the following:
	- block_mindatlas_formbuilder	block_newname
	- block/mindatlas_formbuilder	block/newname
	- blocks/mindatlas_formbuilder	blocks/newname
	- Block mindatlas_formbuilder	Block Newname
	- 'mindatlas_formbuilder'	'newname'