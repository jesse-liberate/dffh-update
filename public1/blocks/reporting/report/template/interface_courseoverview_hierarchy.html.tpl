...
<form action="courseoverview.php" method="get" name="search" id="report">
  ...
  <table class="w-100">
    <tr>
      <td class="pr-5 color-brandcolor-1"><strong>{php} print_string('course_name', 'block_reporting') {/php}</strong></td>
      <td>
        {* @25/07/2018 *}
    ...
    <tr>
      <td class="pr-5 color-brandcolor-1"><strong>{php} print_string('enrolled_date', 'block_reporting') {/php}</strong></td>
      <td>
        ...
        <div class="enrolleddate-range row no-gutters">
          <div class="input-prepend col row no-gutters">
            ...
            <div class="col pr-2">
              <input type="text" name="enrolleddate_from" id="enrolleddate_from" class="datepicker form-control" placeholder="DD/MM/YYYY">
            </div>
          </div>
          <div class="input-prepend col row no-gutters">
            <span class="add-on col-auto">To</span>
            <div class="col">
              <input type="text" name="enrolleddate_to" id="enrolleddate_to" class="datepicker form-control" placeholder="DD/MM/YYYY">
            </div>
          </div>
        </div>
    ...
    <tr>
      <td class="pr-5 color-brandcolor-1"><strong>{php} print_string('completion_date', 'block_reporting') {/php}</strong></td>
      <td>
        {* @23/07/2018 new enhancement *}
        <div class="completiondate-range row no-gutters">
          <div class="input-prepend col row no-gutters">
            <span class="add-on col-auto">From</span>
            <div class="col pr-2">
              <input type="text" name="completiondate_from" id="completiondate_from" class="datepicker form-control" placeholder="DD/MM/YYYY">
            </div>
          </div>
          <div class="input-prepend col row no-gutters">
            <span class="add-on col-auto">To</span>
            <div class="col">
              <input type="text" name="completiondate_to" id="completiondate_to" class="datepicker form-control" placeholder="DD/MM/YYYY">
            </div>
          </div>
        </div>
    ...
    <tr>
      <td class="pr-5 color-brandcolor-1" style='vertical-align: top;'><strong>{php} print_string('hierarchy', 'block_reporting') {/php}</strong></td>
          ...
          {else}
            ...
            <div class="{$user_profile_filter->shortname}-range row no-gutters">
              <div class="input-prepend col row no-gutters">
                <span class="add-on col-auto">From</span>
                <div class="col pr-2">
                  <input type="text" name="{$user_profile_filter->shortname}_from" id="{$user_profile_filter->shortname}_from" class="datepicker form-control" placeholder="DD/MM/YYYY">
                </div>
              </div>
              <div class="input-prepend col row no-gutters">
                <span class="add-on col-auto">To</span>
                <div class="col">
                  <input type="text" name="{$user_profile_filter->shortname}_to" id="{$user_profile_filter->shortname}_to" class="datepicker form-control" placeholder="DD/MM/YYYY">
                </div>
              </div>
            </div>
          ...
          {if $general_filters->filtername == 'lastaccess'}
            ...
            <div class="lastaccess-range row no-gutters">
              <div class="input-prepend col row no-gutters">
                <span class="add-on col-auto">From</span>
                <div class="col pr-2">
                  <input type="text" name="lastaccess_from" id="lastaccess_from" class="datepicker form-control" placeholder="DD/MM/YYYY">
                </div>
              </div>
              <div class="input-prepend col row no-gutters">
                <span class="add-on col-auto">To</span>
                <div class="col">
                  <input type="text" name="lastaccess_to" id="lastaccess_to" class="datepicker form-control" placeholder="DD/MM/YYYY">
                </div>
              </div>
            </div>
    ...
    <tr>
      <td class="pr-5 color-brandcolor-1"><strong>{php} print_string('suspended_users', 'block_reporting') {/php}</strong></td>
      <td>
