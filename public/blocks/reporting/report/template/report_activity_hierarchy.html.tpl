...
{/php}
<div style='text-align:right;margin-bottom:10px'><a href="#" class="btn-custom bg-color-brand-3 hover-bg-color-brand-1 text-white">{php} print_string('export_exel_csv', 'block_reporting') {/php}</a> </div>
