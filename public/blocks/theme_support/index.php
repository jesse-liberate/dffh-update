...
$PAGE->set_heading(get_string('pluginname','block_theme_support'));
$PAGE->set_url('/blocks/theme_support/index.php');

// navbar setting
$PAGE->navbar->ignore_active();
$PAGE->navbar->add('Home', new moodle_url('/'));
$PAGE->navbar->add(get_string("pluginname",'block_theme_support'), new moodle_url('/blocks/theme_support/index.php'));
...
$PAGE->requires->css('/blocks/theme_support/style/plugin.css');

// setup renderer
$output = $PAGE->get_renderer('block_theme_support');


// start outputting html
echo $output->header();
echo $output->heading(get_string('pluginname', 'block_theme_support'));
