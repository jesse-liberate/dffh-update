...
$PAGE->set_heading(get_string('pluginname','block_mindatlas_formbuilder'));
$PAGE->set_url('/blocks/mindatlas_formbuilder/index.php');

// navbar setting
$PAGE->navbar->ignore_active();
$PAGE->navbar->add('Home', new moodle_url('/'));
$PAGE->navbar->add(get_string("pluginname",'block_mindatlas_formbuilder'), new moodle_url('/blocks/mindatlas_formbuilder/index.php'));
...
$PAGE->requires->css('/blocks/mindatlas_formbuilder/style/plugin.css');

// setup renderer
$output = $PAGE->get_renderer('block_mindatlas_formbuilder');


// start outputting html
echo $output->header();
echo $output->heading(get_string('pluginname', 'block_mindatlas_formbuilder'));
