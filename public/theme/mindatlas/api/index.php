...
require_once(__DIR__ . '/dffh_ajax_facetoface_lib.php');
...
$no_require_login_actions = [
    'ajax_get_course_detail',
    'shoppingcart_add_to_cart',
    'shoppingcart_update_orderitem',
    'shoppingcart_update_coupontype',
    'shoppingcart_delete_orderitem',
    'shoppingcart_get_content',
    'shoppingcart_get_ordertype',
    'ajax_get_course_recommendations',
];
