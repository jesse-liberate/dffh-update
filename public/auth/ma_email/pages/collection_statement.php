...
$content = "<div style='padding: 1em'>".get_config('theme_mindatlas', 'collection_statement')."</div>";

/*"<p>This notice outlines how your personal information is collected, used, and shared when you participate in training via the learning management system (LMS).  The Department of Families, Fairness and Housing (the department) is committed to protecting your privacy.</p> 
