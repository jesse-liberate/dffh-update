...
namespace profilefield_menuwithfreetext\privacy;
...
class provider implements
    ...
    public static function get_metadata(collection $collection) : collection {
        return $collection->add_database_table('user_info_data', [
            'userid' => 'privacy:metadata:profilefield_menuwithfreetext:userid',
            'fieldid' => 'privacy:metadata:profilefield_menuwithfreetext:fieldid',
            'data' => 'privacy:metadata:profilefield_menuwithfreetext:data',
            'dataformat' => 'privacy:metadata:profilefield_menuwithfreetext:dataformat'
        ], 'privacy:metadata:profilefield_menuwithfreetext:tableexplanation');
    }
            ...
            if ($context->contextlevel == CONTEXT_USER && $context->instanceid == $user->id) {
                ...
                foreach ($results as $result) {
                    ...
                    \core_privacy\local\request\writer::with_context($context)->export_data([
                        get_string('pluginname', 'profilefield_menuwithfreetext')], $data);
                }
            }
        }
    }
